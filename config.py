...
POPULATION_SIZE = 20
GENERATIONS = 1000
MAX_NOTABLE_MODULES = 25
TEMP_MODULE_TTL = 10
MIN_PROPERTIES_OBS_COUNT = 3
DELETE_NETWORKS_EVERY = 10
NETWORK_REMAIN_PERCENTAGE = 0.8
LAYERS_LIST = ['CONV_1.H', 'CONV_2.H', 'CONV_3.H', 'POOL_2.A', 'POOL_3.A', 'POOL_5.A', 'DROPOUT_20.', 'DROPOUT_40.', 'DROPOUT_60.'
               'CONV_1.N', 'CONV_2.N', 'CONV_3.N', 'POOL_2.M', 'POOL_3.M', 'POOL_5.M', 'RELU_.']
