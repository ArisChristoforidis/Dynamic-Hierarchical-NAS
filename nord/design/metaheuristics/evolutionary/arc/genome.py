...
from .arc_config import OUTPUT, OUTPUT_NAME, INPUT, INPUT_NAME
from .arc_config import UNEVALUATED_FITNESS, FULL_CHANNELS_NO, DROPOUT_PROB

# INITIAL
# layers_list = [CONV_3', 'CONV_5', 'CONV_171', 'POOL_2', 'POOL_3', 'POOL_5']

# f-mnist_arc_CEL_BATCHNORM-16CHANNELS-0.2Dropout_Added_2X2
# layers_list = ['CONV_2', 'CONV_3', 'CONV_5', 'CONV_171', 'POOL_2', 'POOL_3', 'POOL_5']

# After f-mnist_arc_CEL_BATCHNORM-32CHANNELS-0.2Dropout_Added_2X2
# layers_list = ['CONV_2', 'CONV_3', 'CONV_5', 'CONV_151', 'POOL_2', 'POOL_3', 'POOL_5']

# After f-mnist_arc_CEL_BATCHNORM-64-32CHANNELS-0.2Dropout_Added_2X2
# layers_list = ['CONV_2.H', 'CONV_3.H', 'CONV_5.H', 'POOL_2.A', 'POOL_3.A', 'POOL_5.A',
#                'CONV_2.N', 'CONV_3.N', 'CONV_5.N', 'POOL_2.M', 'POOL_3.M', 'POOL_5.M']
