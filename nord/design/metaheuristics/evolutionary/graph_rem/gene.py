...
class LayerGene(Gene):
    ...
    @staticmethod
    def __from_repr__(rpr, bounds_types, bounds):
        g = LayerGene(bounds_types, bounds)
...
class HyperparameterGene(Gene):
    ...
    @staticmethod
    def __from_repr__(rpr, bound_types, bounds):
        g = HyperparameterGene(bound_types, bounds)
