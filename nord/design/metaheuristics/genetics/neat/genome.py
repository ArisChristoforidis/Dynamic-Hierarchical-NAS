...
from .gene import ConnectionGene, LayerGene, HyperparametersGene
...
class Genome(object):
    ...
    def __init__(self, layer_bounds_types, layer_bounds,
        ...
        self.hyperparameters = HyperparametersGene(
            hyperparameters_bounds_types, hyperparameters_bounds)
        ...
        self.hyperparameters_bounds_types = hyperparameters_bounds_types
    ...
    def to_descriptor(self, input_shape, dimensions=2):

        self.active_nodes = 0
        descriptor = NeuralDescriptor()
        previous_in = input_shape[-1]
